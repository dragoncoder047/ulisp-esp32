...
const tbl_entry_t BignumsTable[] PROGMEM = {
    { stringBIGbignum, fn_BIGbignum, 0211, docBIGbignum },
    { stringBIGinteger, fn_BIGinteger, 0211, docBIGinteger },
    { stringBIGbignumstring, fn_BIGbignumstring, 0212, docBIGbignumstring },
    { stringBIGstringbignum, fn_BIGstringbignum, 0212, docBIGstringbignum },
    { stringBIGzerop, fn_BIGzerop, 0211, docBIGzerop },
    { stringBIGadd, fn_BIGadd, 0222, docBIGadd },
    { stringBIGsub, fn_BIGsub, 0222, docBIGsub },
    { stringBIGmul, fn_BIGmul, 0222, docBIGmul },
    { stringBIGdiv, fn_BIGdiv, 0222, docBIGdiv },
    { stringBIGmod, fn_BIGmod, 0222, docBIGmod },
    { stringBIGequal, fn_BIGequal, 0222, docBIGequal },
    { stringBIGless, fn_BIGless, 0222, docBIGless },
    { stringBIGgreater, fn_BIGgreater, 0222, docBIGgreater },
    { stringBIGlogand, fn_BIGlogand, 0222, docBIGlogand },
    { stringBIGlogior, fn_BIGlogior, 0222, docBIGlogior },
    { stringBIGlogxor, fn_BIGlogxor, 0222, docBIGlogxor },
    { stringBIGash, fn_BIGash, 0222, docBIGash },
};
